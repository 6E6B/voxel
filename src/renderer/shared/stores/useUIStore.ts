...
import { TabId, JoinConfig, Account, Game, RobloxInstallation } from '@renderer/shared/types'
import type { AnchoredOverlayPosition } from '@renderer/shared/ui/menus/anchoredPosition'
...
interface UIState {
  ...
  // Context Menus
  activeMenu: ({ id: string } & AnchoredOverlayPosition) | null
...
interface UIActions {
  ...
  // Context Menus
  setActiveMenu: (menu: ({ id: string } & AnchoredOverlayPosition) | null) => void
