    ...
    <div className="flex gap-2 justify-center">
      {values.map((digit, index) => (
        <input
          ...
          className={`w-10 h-12 text-center text-xl font-mono rounded-xl border-2 bg-[var(--color-surface-muted)] text-[var(--color-text-primary)] focus:outline-none transition-all ${isLocked || isSubmitting ? 'opacity-50 cursor-not-allowed' : ''
            } ${hasError
          ...
          <AnimatePresence mode="wait">
                ...
                {isLocked ? (
                  ...
                  <>
                    ...
                    <DialogFooter>
                      <button
                        onClick={onClose}
                        className="flex-1 px-4 py-2 text-sm font-medium text-[var(--color-text-muted)] bg-[var(--color-surface-hover)] hover:bg-[var(--color-surface-strong)] rounded-xl transition-colors"
                      >
                        Cancel
                      </button>
                      <button
                        ...
                        className="flex-1 px-4 py-2 text-sm font-medium text-[var(--accent-color-foreground)] bg-[var(--accent-color)] hover:bg-[var(--accent-color-muted)] disabled:opacity-50 disabled:cursor-not-allowed rounded-xl transition-colors"
                      >
              ...
              >
                ...
                <DialogFooter>
                  <button
                    ...
                    className="flex-1 px-4 py-2 text-sm font-medium text-[var(--color-text-primary)] bg-[var(--color-surface-hover)] hover:bg-[var(--color-surface-strong)] disabled:opacity-50 rounded-xl transition-colors"
                  >
                    Change PIN
                  </button>
                  <button
                    ...
                    disabled={isSubmitting}
                    className={`flex-1 px-4 py-2 text-sm font-medium rounded-xl transition-colors ${removeConfirm
            ...
            {step === 'confirm' && (
              <motion.div
                ...
                className="space-y-4"
              >
                <p className="text-sm text-[var(--color-text-muted)] text-center">Confirm your PIN</p>
                ...
                <DialogFooter>
                  <button
                    onClick={handleBack}
                    disabled={isSubmitting}
                    className="flex-1 px-4 py-2 text-sm font-medium text-[var(--color-text-muted)] bg-[var(--color-surface-hover)] hover:bg-[var(--color-surface-strong)] disabled:opacity-50 rounded-xl transition-colors"
                  >
                    Back
                  </button>
                  <button
