...
import {
  ...
  TrayNotification,
  NotificationType
} from '@renderer/features/system/useNotificationTrayStore'
import { getDropdownMotion } from '../menus/dropdownMotion'
    ...
    <div className="relative z-50">
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ref={trayRef}
            {...getDropdownMotion({ transformOrigin: 'top right', direction: 'down' })}
