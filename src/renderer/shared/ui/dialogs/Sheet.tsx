...
>(({ className, onClick, children, ...props }, ref) => {
  ...
  return (
    <button
      ...
      className={cn(
        'pressable flex items-center justify-center w-7 h-7 rounded-md text-[var(--color-text-muted)] hover:text-[var(--color-text-primary)] hover:bg-[var(--color-surface-hover)] transition-colors',
        className
      )}
      {...props}
    >
