...
export const queryKeys = {
    ...
    avatar: {
        ...
        inventory: (accountId: string, assetTypeIds: number[]) =>
            [...queryKeys.avatar.all, 'inventory', accountId, [...assetTypeIds].sort((a, b) => a - b)] as const,
    ...
    userProfile: {
        ...
        collectiblesRap: (userId: number, cookie: string) =>
            [...queryKeys.userProfile.all, 'collectiblesRap', userId, cookie] as const,
    ...
    catalog: {
        ...
        search: (params: Record<string, unknown>) => [...queryKeys.catalog.all, 'search', params] as const,
    ...
    inventory: {
        ...
        v2: (cookie: string, userId: number, assetTypes: string[], sortOrder: 'Asc' | 'Desc') =>
            [...queryKeys.inventory.all, 'v2', cookie, userId, assetTypes.sort().join(','), sortOrder] as const,
        thumbnails: (assetIds: number[]) => [...queryKeys.inventory.all, 'thumbnails', assetIds] as const
    },
    groups: {
        all: ['groups'] as const,
