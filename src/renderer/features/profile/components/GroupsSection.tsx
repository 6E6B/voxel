            ...
            {isLoading ? (
              ...
              groups.map((groupItem, index) => {
                ...
                return (
                  ...
                  >
                    <div className="relative w-20 h-20 rounded-xl bg-[var(--color-surface-hover)] shadow-md ring-1 ring-[var(--color-border-subtle)] group-hover:ring-[var(--color-border-strong)] transition-all overflow-hidden">
                      <img
