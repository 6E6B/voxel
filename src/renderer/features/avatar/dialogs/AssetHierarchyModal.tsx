...
import { LuaHighlighter } from '@renderer/shared/ui/specialized/LuaHighlighter'
          ...
          {loading ? (
            ...
            <div className="flex w-full h-full">
              ...
              <div className="w-1/3 border-r border-neutral-800 flex flex-col bg-neutral-950/50">
                <div className="p-3 text-xs font-semibold text-neutral-500 tracking-wider border-b border-neutral-800/50 bg-neutral-900/20">
                  Explorer
                </div>
              ...
              <div className="w-2/3 flex flex-col bg-neutral-900/10">
                <div className="p-3 text-xs font-semibold text-neutral-500 tracking-wider border-b border-neutral-800/50 bg-neutral-900/20 flex justify-between items-center">
