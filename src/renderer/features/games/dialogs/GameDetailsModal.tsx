...
import { Account, Game, JoinMethod } from '@renderer/shared/types'
...
import { Dialog, DialogBody, DialogContent } from '@renderer/shared/ui/dialogs/Dialog'
...
import { SocialLink, VoteResponse, GamePass } from '@shared/contracts/games'
                  ...
                  {activeTab === 'info' ? (
                    ...
                    <div className="flex-1 min-h-0">
                      <ServersList
                        ...
                        onJoinPrivateServer={(placeId, accessCode) => {
                          onLaunch({ method: JoinMethod.PrivateServer, target: `${placeId}:${accessCode}` })
                          onClose()
                        }}
                      />
                    </div>
