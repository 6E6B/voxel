    ...
    <div className="flex gap-2 sm:gap-3 justify-center">
      {values.map((digit, index) => (
        <input
          ...
          className={`w-10 h-12 sm:w-12 sm:h-14 text-center text-xl sm:text-2xl font-mono rounded-lg border-2 bg-neutral-900 text-white focus:outline-none transition-all ${isSubmitting ? 'opacity-50 cursor-not-allowed' : ''
            } ${error
