...
export const pagedPrivateServerSchema = z.object({
  gameJoinRestricted: z.boolean().optional(),
  previousPageCursor: z.string().nullable(),
  nextPageCursor: z.string().nullable(),
  data: z.array(privateServerSchema)
})
...
export const discoveryRecommendationSchema = z
  .object({
    contentType: z.string(),
    contentId: z.number().optional(),
    contentStringId: z.string().optional(),
    contentMetadata: z.record(z.string(), z.any()).optional(),
    analyticsData: z.record(z.string(), z.any()).optional()
  })
  .passthrough()

export const discoverySortSchema = z
  .object({
    topic: z.string().optional(),
    subtitle: z.string().optional(),
    topicId: z.number().optional(),
    treatmentType: z.string().optional(),
    recommendationList: z.array(discoveryRecommendationSchema).nullable().optional(),
    nextPageTokenForTopic: z.string().nullable().optional(),
    numberOfRows: z.number().optional(),
    topicLayoutData: z.record(z.string(), z.string()).optional(),
    analyticsData: z.record(z.string(), z.any()).optional(),
    subId: z.string().optional()
  })
  .passthrough()

export const discoveryGameMetadataSchema = z
  .object({
    ...
    under9: z.boolean().optional(),
    under13: z.boolean().optional(),
    minimumAge: z.number().optional(),
    contentMaturity: z.string().optional(),
    ageRecommendationDisplayName: z.string().optional(),
    layoutDataBySort: z.record(z.string(), z.any()).optional()
  })
  .passthrough()

export const discoveryHomeResponseSchema = z
  .object({
    pageType: z.string().optional(),
    requestId: z.string().optional(),
    sorts: z.array(discoverySortSchema).default([]),
    sortsRefreshInterval: z.number().optional(),
    contentMetadata: z
      .object({
        Game: z.record(z.string(), discoveryGameMetadataSchema).optional()
      })
      .passthrough()
      .optional(),
    contentMetadataByStringId: z.record(z.string(), z.any()).optional(),
    nextPageToken: z.string().nullable().optional(),
    isSessionExpired: z.boolean().optional(),
    globalLayoutData: z.record(z.string(), z.any()).optional(),
    isPartialFeed: z.boolean().optional(),
    DebugInfoGroups: z.union([z.array(z.any()), z.record(z.string(), z.any()), z.null()]).optional(),
    sdui: z.union([z.record(z.string(), z.any()), z.null()]).optional()
  })
  .passthrough()
...
export type DiscoveryHomeResponse = z.infer<typeof discoveryHomeResponseSchema>
export type DiscoveryHomeSort = z.infer<typeof discoverySortSchema>
export type DiscoveryRecommendation = z.infer<typeof discoveryRecommendationSchema>
export type DiscoveryGameMetadata = z.infer<typeof discoveryGameMetadataSchema>
