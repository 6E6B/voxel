import { z } from 'zod'
import { AccountStatus } from '../models/app'
...
export const bulkUserProfileNamesSchema = z.object({
  userId: z.number(),
  names: z
    .object({
...
export const bulkUserProfilesResponseSchema = z.object({
  profileDetails: z.array(bulkUserProfileNamesSchema).default([]),
