import { autoUpdater, type UpdateInfo as ElectronUpdateInfo, type ProgressInfo as ElectronProgressInfo } from 'electron-updater'
import { BrowserWindow, app } from 'electron'
import log from 'electron-log'
import path from 'path'
import fs from 'fs'
import { updateStateSchema, type UpdateState } from '@shared/contracts/updater'
...
class UpdaterService {
  ...
  private setupEventListeners(): void {
    ...
    autoUpdater.on('download-progress', (progress: ElectronProgressInfo) => {
  ...
  private updateState(partial: Partial<UpdateState>): void {
    this.state = updateStateSchema.parse({ ...this.state, ...partial })
